...
> [资源分享](https://www.123pan.com/s/0l7bVv-d5yHh.html)
...
- 启动器（任选一个）
  ...
  - [Minecraft 官方启动器](https://www.minecraft.net/zh-hans/download)（自动安装Java环境，无需手动操作）

::: tip
官方启动器游戏文件夹：`C:\Users\{用户名}\AppData\Roaming\.minecraft`

第三方启动器游戏文件夹：同目录下 `.minecraft`
:::
...
::: tip
如需装光影，1.14 以前需装 OptiFine（高清修复），1.14以后 Fabric 端需安装 Sodium（钠）和 Iris Shaders，Forge 端需安装 Rubidium（铷）和 Lithium（锂）
:::
...
- 通过网站下载<br>
  通过国内 MC 百科等网站或国外 [CurseForge](https://www.curseforge.com/minecraft)、[Modrinth](https://modrinth.com/) 等网站下载对应版本游戏资源

::: tip
下载模组时注意要求的游戏版本与模组加载器，如果有前置模组则也要下载

注意将下载的文件放在对应版本文件夹的相应文件夹下
:::
...
| **空格键** | 跳跃；创造模式下双击起飞 |
| **左Shift** | 潜行；飞行模式下下降 |
| **Q** | 丢弃单个物品；Ctrl+Q丢弃整组（Mac需按Ctrl+Cmd+Q） |
| **E** | 打开物品栏（Beta1.3前为I键） |
| **F** | 交换主副手物品；1.8前版本调整可视范围 |
| **T** | 打开聊天栏（多人游戏可用） |
| **L** | 查看进度 |
...
| **F5** | 切换第一/第三人称视角 |
| **F11** | 切换全屏/窗口模式 |
| **Ctrl+中键** | 复制带NBT标签的方块（如箱子内容、告示牌文字） |
